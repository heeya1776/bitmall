...
<table width="800" border="1" cellspacing="0" bordercolordark="white" bordercolorlight="black">
	...
	<tr bgcolor="#F2F2F2" height="23">	
		<td width="100">&nbsp id2</td>	
		<td width="100">&nbsp 홍길동1</td>	
		<td width="100">&nbsp 02 -123-1234</td>	
		<td width="100">&nbsp 011-123-1234</td>	
		<td width="200">&nbsp abcd@abcd.com</td>	
		<td width="100" align="center">탈퇴</td>	
		<td width="100" align="center">
			<a href="#">수정</a>/
			<a href="#">삭제</a>
		</td>
...
<table width="800" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td height="30" class="cmfont" align="center">
			<img src="/assets/images/admin/i_prev.gif" align="absmiddle" border="0"> 
			...
			<img src="/assets/images/admin/i_next.gif" align="absmiddle" border="0">
		</td>
	</tr>
</table>
</center>
