...
<!-------------------------------------------------------------------------------------------->	
			...
			<table border="0" cellpadding="0" cellspacing="0" width="746">
				<tr>
					<td height="30" align="left"><img src="/assets/images/cart_title.gif" width="746" height="30" border="0"></td>
				</tr>
			</table>
			<table border="0" cellpadding="0" cellspacing="0" width="747">
				<tr><td height="13"></td></tr>
			...
			<table border="0" cellpadding="0" cellspacing="0" width="710" class="cmfont">
				<tr>
					<td><img src="/assets/images/cart_title1.gif" border="0"></td>
				</tr>
			</table>
				...
				<tr>
					...
					<td height="60" align="center" bgcolor="#FFFFFF">
						<table cellpadding="0" cellspacing="0" width="100%">
							<tr>
								<td width="60">
									<a href="product_detail.jsp?product_num=0000"><img src="/assets/images/product/0000_s.jpg" width="50" height="50" border="0"></a>
								</td>
								<td class="cmfont">
					...
					<td align="center" bgcolor="#FFFFFF"><font color="#464646">70,200</font></td>
					<td align="center" bgcolor="#FFFFFF">
						<input type="image" src="/assets/images/b_edit1.gif" border="0">&nbsp<br>
						<a href = "#"><img src="/assets/images/b_delete1.gif" border="0"></a>&nbsp
					</td>
					</form>
				</tr>
				<tr>
