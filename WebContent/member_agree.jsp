	...
	<tr>
		...
		<!-------------------------------------------------------------------------------------------->	
			...
			<table border="0" cellpadding="0" cellspacing="0" width="747">
				...
				<tr>
					<td height="30" align="center">
						<p><img src="/assets/images/login_title.gif" width="747" height="30" border="0"></p>
					</td>
				</tr>
				<tr><td height="13"></td></tr>
			</table>
			...
			<table border="0" cellpadding="0" cellspacing="0" width="685" class="cmfont">
				<tr>
					<td><img src="/assets/images/login_title1.gif" width="85" height="15" border="0"></td>
				</tr>
			...
			<table border="0" cellpadding="0" cellspacing="0" width="685" class="cmfont">
				<tr>
					<td height="45" align="right">
						<a href="javascript:CheckAgree()"><img src="/assets/images/b_agreeok.gif" border="0"></a> 
						<a href="index.html"><img src="/assets/images/b_agreeno.gif" border="0"></a>
					</td>
				</tr>
			</table>
...
<table width="959" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	<tr> 
		<td background="/assets/images/footer_bg.gif" height="11"></td>
	</tr>
	...
	<tr> 
		<td> 
			<table width="959" border="0" cellspacing="0" cellpadding="0">
				<tr> 
					<td valign="top"><a href="index.html"><img src="/assets/images/footer_logo.gif" border="0"></a></td>
					<td width="28"></td>
					<td> 
						<table border="0" cellspacing="0" cellpadding="0">
							<tr> 
								<td> 
									<table border="0" cellspacing="0" cellpadding="0">
										<tr> 
											<td><a href="company.html"><img src="/assets/images/footer_menu01.gif" border="0"></a></td>
											<td><img src="/assets/images/footer_line.gif"></td>
											<td><a href="useinfo.html"><img src="/assets/images/footer_menu02.gif" border="0"></a></td>
											<td><img src="/assets/images/footer_line.gif"></td>
											<td><a href="policy.html"><img src="/assets/images/footer_menu03.gif" border="0"></a></td>
										</tr>
									</table>
								</td>
							</tr>
							<tr> 
								<td><img src="/assets/images/footer_copyright.gif"></td>
							</tr>
						</table>
					</td>
					<td align="right" valign="top">
						<table border="0" cellspacing="0" cellpadding="0">
							<tr> 
								<td align="right">
										<a href="index.html"><img src="/assets/images/footer_home.gif" border="0"></a>&nbsp
										<a href="#top"><img src="/assets/images/footer_top.gif" border="0"></a>
								</td>
							</tr>
							<tr>
								<td>
									<table border="0" cellspacing="0" cellpadding="0">
										<tr> 
											<td><A HREF="http://www.ftc.go.kr/" target="_blank"><img src="/assets/images/footer_pic1.gif" border=0></A></td>
											<td><img src="footer_line.gif" width="3" height="42"></td>
											<td><A HREF="http://www.sgic.co.kr/" target="_blank"><img src="/assets/images/footer_pic2.gif" border=0></a></td>
										</tr>
									</table>
								</td>
							<tr> 
